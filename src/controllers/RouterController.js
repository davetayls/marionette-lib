var ActionPolicy, BaseController, RouterController, _,
...
RouterController = (function(_super) {
  ...
  RouterController.prototype.authorizeAction = function(actionName, actionConfig) {
  ...
  RouterController.prototype.addAction = function(actionName, actionConfig) {
    ...
    if (_.isFunction(_fn)) {
      return this[actionName] = (function(_this) {
        return function() {
          if (_this.getOption('authorizeAction').call(_this, actionName, actionConfig)) {
