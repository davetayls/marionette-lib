...
import RouterController = require('../../src/controllers/RouterController');
...
describe('RouterController', function() {
  ...
  describe('authorize method', function() {
    it('should not run method if not authorized', function() {
      var fooFn = sinon.spy();
      var ctrl:any = new RouterController.RouterController({
        authorizeAnAction: function(fnName:string, actionConfig:RouterController.IActionConfig) {
    ...
    it('should allow handling individual unauthorized action', function() {
      ...
      var ctrl:any = new RouterController.RouterController({
        ...
        actions: {
          foo: {
            fn: fooFn,
            unauthorized: function(actionName:string, actionConfig:RouterController.IActionConfig) {
